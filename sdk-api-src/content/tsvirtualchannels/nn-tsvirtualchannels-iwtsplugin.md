...
The **IWTSPlugin** interface is implemented by %System32%\webauthn.dll to enable the Remote Desktop WebAuthn redirection functionality. Get an instance of this interface by calling <a href="/windows/desktop/TermServ/virtualchannelgetinstance">VirtualChannelGetInstance</a>, which is also provided by webauthn.dll.
